  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-4 right-4 flex items-center justify-between p-[2em] pointer-events-none z-20 bg-zinc-800/20 mt-3 rounded-md backdrop-blur-md border-0 border-black"
